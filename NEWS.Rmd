...
The features and bug fixes implemented in version 1.0.3.90xx are available on 
**develop branch** only.
...
Function for renaming taxa in a taxonomic table. It comes with functionality for 
...
Function for editing node labels, i.e., shortening to a certain length and 
removing unwanted characters. It is used by NetCoMi's plot functions 
...
Internal functions have been renamed to follow general naming conventions, 
