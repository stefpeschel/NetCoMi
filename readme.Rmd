...
TSS, CSS, COM, VST, and the clr transformation are described in [Badri et al., 2018]. 
...
```{r example4, , fig.height=10, fig.width=10}
...
```{r example5, fig.height=10, fig.width=10}
...
```{r example14, fig.height=10, fig.width=10}
...
*Lippard, N&aelig;ss, and Sinding-Larsen*, 211-216, 1999.)

[Badri et al., 2018] Michelle Badri, Zachary Kurtz, Christian M&uuml;ller, and Richard
Bonneau. [Normalization methods for microbial abundance data
strongly affect correlation estimates](https://www.biorxiv.org/content/10.1101/406264v1). 
*bioRxiv*, 2018. doi: 406264.
